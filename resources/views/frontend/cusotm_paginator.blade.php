...
{{--            <li class="disabled"><a  class="page-link" href="javascript:void(0);" rel="prev">{{ __('Prev') }}</a></li>--}}
{{--        @else--}}
{{--            <li><a  class="page-link" href="{{ $paginator->previousPageUrl() }}" rel="prev">{{ __('Prev') }}</a></li>--}}
{{--        @endif--}}
                    ...
                    @foreach ($element as $page => $url)
                            ...
                            @else
                                <li class="page-item page-navigation__item"><a href="{{ $url }}"
                                                                               class="page-link page-navigation__link">{{ $page }}</a>
                                </li>
                            @endif
                    @endforeach
                @endif
