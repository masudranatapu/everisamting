    ...
    <section class="section dashboard dashboard--user">
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-xl-9">
                    <form action="{{ route('frontend.user-business-directory.store') }}" enctype="multipart/form-data"
                          method="post">
                        @csrf
                        <div class="card">
                            <div class="card-header">
                                <div class="dashboard__posted-ads">
                                    <div class="dashboard__section-info">
                                        <h2 class="dashboard-card__title">{{ __('ad_my_business') }}</h2>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <div class="text-center m-3" style="display: none;" id="showImageArea">
                                            <img src="" alt="event-image" id="showImage" width="400px">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="card-footer">
                                <div class="row">
                                    <div class="col-md-12 text-center p-4">
                                        <button class="btn" type="submit">{{ __('ad_my_business') }}</button>
                                    </div>
                                </div>
                            </div>
                        </div>
...
{{--                if (category_id) {--}}
{{--                    $.ajax({--}}
{{--                        url: "{{ url('/dashboard/user-business-directory/category/subcategory') }}/" +--}}
{{--                            category_id,--}}
{{--                        type: "GET",--}}
{{--                        dataType: "json",--}}
