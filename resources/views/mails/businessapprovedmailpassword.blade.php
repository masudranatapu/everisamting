...
<html>
    <head>
        <title>You have a new query from Everisamting</title>
    </head>
    <body>
                    ...
                    <td width="100%" align="center" valign="top" bgcolor="#E4E6E9" style="background-color:#E4E6E9; min-height: 200px;">
                        <table>
                            <table class="header-row" width="378" cellspacing="0" cellpadding="0" border="0" style="table-layout: fixed; text-align: center; margin-bottom: 5px; margin-top: 30px; margin-left: 150px;">
                                <tbody>
                                    <tr>
                                        <td class="header-row-td" style="font-family: Arial, sans-serif; font-weight: normal; line-height: 19px; color: #2D3748; margin: 0px; font-size: 25px; padding-bottom: 10px; text-aling: center; margin-left: 100px;" valign="top" align="left"> Everisamting </td>
                                    </tr>
                                </tbody>
                            </table>
                            <tbody>
                                                                ...
                                                                <tr>
                                                                    <td class="table-col-td" width="378" style="font-family: Arial, sans-serif; line-height: 19px; color: #444444; font-size: 13px; font-weight: normal; width: 378px;" valign="top" align="left">
                                                                        <table class="header-row" width="378" cellspacing="0" cellpadding="0" border="0" style="table-layout: fixed;">
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td class="header-row-td" width="378" style="font-family: Arial, sans-serif; font-weight: bold; line-height: 19px; color: #2D3748; margin: 0px; font-size: 18px; padding-bottom: 10px; padding-top: 15px; text-aling: center; margin: 0 auto;" valign="top" align="left">Hello {{ $details['name'] }} !</td>
                                                                                </tr>
                                                                            </tbody>
                                                                        </table>
                                                                        <table class="header-row" width="378" cellspacing="0" cellpadding="0" border="0" style="table-layout: fixed;">
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td class="header-row-td" width="378" style="font-family: Arial, sans-serif; font-weight: normal; line-height: 18px; color: #2D3748; margin: 0px; font-size: 17px; padding-bottom: 10px; padding-top: 15px;" valign="top" align="left">Mail form  {{ $details['mailform'] }}</td>
                                                                                </tr>
                                                                            </tbody>
                                                                        </table>
                                                                        <table class="header-row" width="378" cellspacing="0" cellpadding="0" border="0" style="table-layout: fixed;">
                                                                        ...
                                                                        <div style="font-family: Arial, sans-serif; line-height: 20px; ">
                                                                            <a href="{{ $details['action_button'] }}" style="color: #777777;  font-size: 15px;" >
                                                                                Go to you account
                                                                            </a>
                                                                        </div>
                                                                    </td>
