            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title" style="line-height: 36px;">{{ __('create_product_model') }}</h3>
                    ...
                    <div class="row pt-3 pb-4">
                        <div class="col-md-6 offset-md-3">
                            <form class="form-horizontal" action="{{ route('module.model.store') }}" method="POST">
                                @csrf
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <select name="status" id="status" class="form-control">
                                            ...
                                            <option value="0" {{ old('status') == '0' ? 'active' : '' }} >{{ __('inactive') }}</option>
                                        </select>
                                        @error('status')
                                            <span class="invalid-feedback"
                                                role="alert"><strong>{{ $message }}</strong></span>
                                ...
                                <div class="form-group row">
                                    <div class="offset-sm-3 col-sm-4">
                                        <button type="submit" class="btn btn-success"><i
                                                class="fas fa-plus"></i>&nbsp;{{ __('add_product_model') }}</button>
                                    </div>
                                </div>
                            </form>
                        </div>
