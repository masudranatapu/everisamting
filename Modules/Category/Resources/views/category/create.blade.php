                        ...
                        <div class="col-md-6 offset-md-3">
                            <form class="form-horizontal" action="{{ route('module.category.store') }}" method="POST"
                                ...
                                <div class="form-group row">
                                    <label class="col-sm-3">Category Type <span class="text-danger">*</span></label>
                                    <div class="col-sm-9">
                                        <select name="type" class="form-control" required>
                                            <option value="1">General</option>
                                            <option value="2" @if(request('type') && request('type') == 2) selected @endif >Business Directory</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input value="{{ old('name') ?? request('name') }}" name="name" type="text"
