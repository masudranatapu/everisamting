            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title" style="line-height: 36px;">{{ __('create_service_type') }}</h3>
                    ...
                    <div class="row pt-3 pb-4">
                        <div class="col-md-6 offset-md-3">
                            <form class="form-horizontal" action="{{ route('module.serviceType.store') }}" method="POST">
                                @csrf
                                <div class="form-group row">
                                    <x-forms.label name="service_type" required="true" class="col-sm-3" />
                                    <div class="col-sm-9">
                                        <input value="{{ old('service_type') }}" name="service_type" type="text"
